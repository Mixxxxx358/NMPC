...
if __name__ == "__main__":
    ...
    x_reference_list = stackReferences((np.zeros((500)), randomLevelReference(500, [25,30], [-1, 1])))
    np.save("references/randomLevelTime25_30Range-1_1Nsim500.npy", x_reference_list)
